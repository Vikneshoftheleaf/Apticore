    ...
    return (
        <div>
            {currentQuestions.map((question) => (
                <div key={question.id} className="p-8 flex flex-col gap-4  bg-white items-start border-b-2">
                    ...
                    {selectedAnswers[question.id] && (
                        <p className="text-sm mb-2" style={{ color: selectedAnswers[question.id] === 'Correct!' ? 'green' : 'red' }}>
                    ...
                    {showExplanation[question.id] && <div className="rounded-md bg-green-50 p-4"><p ><span className="font-semibold text-green-500">Correct Answer: </span>{question.correctAnswer}</p><br /><p><span className="font-semibold text-green-500">Explanation: </span> <br /> {question.explanation}</p></div>}
                </div>
            ))}
