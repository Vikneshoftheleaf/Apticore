    ...
    return (
        <div>
            {currentQuestions.map((question) => (
                <div key={question.id} className="lg:p-8 px-4 py-8 flex flex-col gap-4 bg-white items-start border-b-2">
                    ...
                    <button onClick={() => toggleExplanation(question.id)} className="bg-green-50 p-2 border border-green-500 rounded-md">
